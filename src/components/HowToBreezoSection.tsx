...
import breezo_app from  "@/assets/breezo_app.webp";
...
const impactsData = [
  ...
  {
    id: "step-business",
    title: "For Corporates & Fleets",
    image: "/bike_docking.jpg",
    description:
  ...
  return (
    <section className="bg-[#0F0F0F] text-white py-16 px-6 sm:px-10 lg:px-20 text-center relative">
      ...
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-lexend text-white leading-tight mb-10 uppercase">
        Ride the <span className="text-breezo-green font-extrabold">Breezo</span> way
      </h2>
