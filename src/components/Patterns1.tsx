import pattern from "@/assets/Untitled.png";


export default function PatternDivider() {
  return (
    <div className="relative w-full overflow-hidden flex items-center justify-center px-6 sm:px-10 lg:px-20 py-6 sm:py-8 lg:py-10 border-t-4 border-b-4">
